...
type SignatureResult = Awaited<ReturnType<AuthorizationType['signature']>> | undefined;
type SignatureParams = Parameters<AuthorizationType['signature']>[0];
export type { SignatureParams, SignatureResult, };
